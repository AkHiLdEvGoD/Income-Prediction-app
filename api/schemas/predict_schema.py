...
class InputData(BaseModel):
    ...
    educational_num: Annotated[int, Field(..., ge=1, le=20, description="Education level in numeric form (1–20)")]
    marital_status: Annotated[str, Field(..., min_length=2, description="Marital status")]
    ...
    capital_gain: Annotated[int, Field(..., ge=0, description="Capital gain (non-negative)") ]
    capital_loss: Annotated[int, Field(..., ge=0, description="Capital loss (non-negative)")]
    hours_per_week: Annotated[int, Field(..., ge=1, le=100, description="Number of working hours per week (1–100)")]
    native_country: Annotated[str, Field(..., min_length=2, description="Country of origin")]